...
3. Initialize publication: `ent prj pbs-init` (requires the git bundle repo url) allows the deployment inside platform
4. Attach to kubernetes for an Entando application via ent attach-kubeconfig config-file or similar allows the deployment inside platform
